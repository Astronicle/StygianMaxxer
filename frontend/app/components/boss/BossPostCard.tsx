...
type BossPostCardProps = {
  post: PostSummary;
  highlightBossId?: number; // boss this page is scoped to — gets a highlighted ring
};
    ...
    <div className="card bg-base-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
      <div className="card-body gap-2 p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="badge badge-xs badge-outline ml-auto" title="Total cost">💰 {post.totalCost}</span>
        </div>
        ...
        {/* All bosses in the post — highlighted boss gets a ring + background */}
